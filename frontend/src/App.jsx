      ...
      <div className='App'>
        ...
        <Switch>
          <LayoutRoute
            exact
            path='/'
            title='AskTribe - Where Developers Learn, Share, & Build Careers'
          >
            <HomePage/>
          </LayoutRoute>
          <LayoutRoute
